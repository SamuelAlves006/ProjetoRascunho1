<?php
    ...
    if(mysqli_num_rows($resultado) > 0) {
        ...
        if (mysqli_query($conexao, $sql)) {
            echo "<h2 style='color:#000000;text-align:center;font-family:Montserrat, sans-serif;font-weight:500;margin-top:60px'>Usuário cadastrado com sucesso</h2>";
            echo "<h3 style='color:#000000;text-align:center;font-family:Montserrat, sans-serif;font-weight:500'>Volte para a tela de login!</h3>";
        } else {
